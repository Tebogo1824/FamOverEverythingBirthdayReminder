...
const INITIAL_BIRTHDAYS: Birthday[] = [
  ...
  },
  {
    ...
    name: 'Kaku',
    date: '1965-09-02',
    message: 'Happy birthday to the pillar of our family. We love you so much kaku!',
  ...
  },
  {
    ...
    name: 'Seemisho',
    date: '1998-07-29',
    message: 'Another year older, another year wiser. Have a great one seemi!',
  ...
  },
  {
    ...
    name: 'Hlare',
    date: '1978-08-12',
    message: 'Another year older, another year wiser. Have a great one Hlare!',
    photoUrl: PRESET_PHOTOS[2],
  },
];
